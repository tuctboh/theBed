...
<html>
<head>
<title>Alexa The Bed sign-up</title>
...
{
  echo  'Please use the full url provided by the \'The Bed\' application';
} else {
...
<td>TheBedPassProxy URL</td><td><input type="text" name="proxyurl"></td>
<tr>
<td><input id="button" type="submit" name="submit" value="Sign-Up"></td>
    ...
    print $output['access'];
    print ' is an invalid access code, please use the full url provided by the `The Bed` Alexa skill';
  }
}
?>
</body>
